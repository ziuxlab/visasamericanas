...
<header id="header-navbar" class="">
    <div class=" text-white">
        <div class="content-boxed sub-menu">
            <div class="flex-between col-sm-12 v-center push-10 push-10-t ">
                ...
                <ul class="menu v-center push-15-t">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right remove-padding">
                                ...
                                <li class="">
                                    <a class=" text-capitalize bg-primary"
                                       href=""><i class="fa fa-star push-5-r"></i><span class="text-white ">VISA PRIMERA VEZ</span></a>
                                </li>
                                <li class="">
                                    <a class="text-capitalize bg-primary"
                    ...
                    <li class="visible-lg">
                        <a class="text-capitalize    bg-primary-dark"
                           href=""><i class=" text-white fa fa-star push-5-r"></i><span class="text-white">INICIO</span></a>
                    </li>
                    <li class="visible-lg">
                        <a class="text-capitalize bg-primary"
                           href=""><i class="fa fa-star push-5-r"></i><span class=" text-white ">VISA PRIMERA VEZ</span></a>
