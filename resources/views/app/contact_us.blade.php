...
@section('critical-css')
    <style>@charset "UTF-8";
        @import url(https://fonts.googleapis.com/css?family=Raleway:300,400,600|Maven+Pro);
        ...
        <div class="content-boxed">
            <div class="content content-narrow  content-full">
                <div class="row flex push-30-t push-30">
                    ...
                    <div class="col-sm-6 bg-white remove-padding">
                        <div class="block">
                            <div class="">
                                ...
                                <div class="content content-narrow">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                                {!! Form::label(trans('general.phone').':', null, ['class' => 'control-label']) !!}
                                                {!! Form::text('phone', old('phone'), ['class' => 'form-control','placeholder'=>trans('general.placeholder phone')]) !!}
                                                @if ($errors->has('phone'))
                                                    <span class="help-block">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
                                                {!! Form::label(trans('general.country').':', null, ['class' => 'control-label']) !!}
                                                {!! Form::text('country', old('country'), ['class' => 'form-control','placeholder'=>trans('general.placeholder country')]) !!}
                                    ...
                                    <div class="form-group {{ $errors->has('text') ? ' has-error' : '' }}">
                                        {!! Form::label(trans('general.message').':', null, ['class' => 'control-label']) !!}
                                        {!! Form::textarea('text', old('text'), ['class' => 'form-control','rows'=>3,'required','placeholder'=>trans('general.placeholder message')]) !!}
                                        @if ($errors->has('text'))
                                            <span class="help-block">
