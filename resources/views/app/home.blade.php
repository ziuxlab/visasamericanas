        ...
        <div class="row content flex-center  flex-sm-row flex-xs-column">
            <div class="col-sm-4 push-20 ">
                <div class="row  flex-md-center flex-md-column flex-sm-row">
                    ...
                    <div class="col-md-9 col-sm-12 text-md-center text-xs-left">
                        <h3 class="text-primary-dark h4 ">Linea gratuita nacional</h3>
                        <h3 class="text-primary h4"><strong><a href="tel:018000413519">01 8000 413 519</a></strong></h3>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 push-20   ">
                <div class="row flex-md-center flex-md-column flex-sm-row">
                    ...
                    <div class="text-md-center col-md-9 col-sm-12 text-xs-left">
                        <h3 class="text-primary-dark h4 ">Celular y whatsapp</h3>
                        <h3 class="text-primary h4"><strong><a href="tel:3207085420">(+57) 320-708-5420 </a><br><a
            ...
            <div class="col-sm-4  push-20 ">
                <div class="row  flex-md-center flex-md-column flex-sm-row">
                    ...
                    <div class="col-md-9 col-sm-12 text-md-center text-xs-left">
                        <h3 class="text-primary-dark h4 ">Otras lineas celulares</h3>
                        <h3 class="text-primary h4"><strong><a href="tel:3225683594"> (+57) 322-568-3594</a></strong></h3>
                    </div>
                </div>
            </div>
