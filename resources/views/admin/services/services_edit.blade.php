...
@section('contenido')
    @include('layouts.admin.partials._titulos_CRUD',['h1'=>'Servicio','h2'=>'Editar Servicio'])
    <div class="content overflow-hidden">
        
        <div class="col-sm-12">
            <div CLASS="block block-bordered block-rounded block-themed ">
                {!! Form::model($package,['action'=> ['ServicesController@update',$package->id],'method' => 'put','files' => 'true']) !!}
                <div class="block-header bg-primary">
                    <h3 class="h4">Formulario para editar un Servicio</h3>
                </div>
