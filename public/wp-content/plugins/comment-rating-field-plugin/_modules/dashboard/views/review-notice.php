<div class="notice notice-info is-dismissible wpzinc-review-<?php echo $this->plugin->name; ?>">
	...
	<p>
		<a href="https://wordpress.org/support/plugin/<?php echo $this->plugin->review_name; ?>/reviews/?filter=5#new-post" class="button button-primary" target="_blank">
			<?php _e( 'Yes, Leave Review', $this->plugin->name ); ?>
		</a>
		<a href="<?php echo $this->plugin->support_url; ?>" class="button" target="_blank">
