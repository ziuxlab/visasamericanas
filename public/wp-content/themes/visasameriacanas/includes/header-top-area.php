				...
				<ul class="contact_details">
					<?php
						...
						if( $header_email = mfn_opts_get( 'header-email' ) ){
							echo '<li class="mail"><i class="icon-mail-line"></i>Correo: <a href="mailto:'. $header_email .'">'. $header_email .'</a></li>';
						}
					?>
				</ul>
				...
				<?php 
					if( has_nav_menu( 'social-menu' ) ){
						...
						echo '<ul class="social">';
							...
							if( mfn_opts_get('social-youtube') ) echo '<li class="youtube"><a '.$target.' href="'. mfn_opts_get('social-youtube') .'" title="YouTube"><i class="icon-youtube"></i></a></li>';						
