...
<div id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="section section-post-header">
		<div class="section_wrapper clearfix">
			...
			<div class="column two-fifth single-photo-wrapper">
			...
			<div class="column three-fifth post-header">
			
				<div class="button-love"><?php echo mfn_love() ?></div>
				
				<div class="title_wrapper">
					<?php
						if( $title = get_post_meta(get_the_ID(), 'mfn-post-author', true) ){
							echo '<h1 class="entry-title" ><b>'. $title .'</b></h1>';
						}
					?>
					...
					<?php
						if( mfn_opts_get( 'blog-title' ) ){ 
							if( get_post_format() == 'quote'){
								...
								echo '<h5 itemprop="headline">'. get_the_title() .'</h5>';
							}
						}
					?>
			...
			<div class="column three-fifth post-wrapper-content">
		...
		<div class="entry-content">
				<div class="section mcb-section dark  " style="padding-top:50px; padding-bottom:20px;">
					<div class="section_wrapper mcb-section-inner">
						<div class="wrap mcb-wrap one  clearfix" style="padding:; background-color:">
							<div class="column mcb-column one-second column_promo_box service-box-left">
								<div class="promo_box no_border">
									<div class="promo_box_wrapper promo_box_left">
										<div class="photo_wrapper">
											<img class="scale-with-grid" src="/wp-content/uploads/2014/09/primera.png" alt="" width="493" height="191">
										</div>
										<div class="desc_wrapper">
											<div class="desc">
												<h5>VISA DE TURISMO </h5>
												<h3><b>PRIMERA VEZ</b></h3>
											</div>
											<a href="/visa-por-primera-vez/" id="btn-service" class="button button_left button_theme button_js kill_the_icon">
												<span class="button_icon">
													<i class="icon-plus"></i>
												</span>
												<span class="button_label">Ver Más</span>
											</a>
										</div>
									</div>
								</div>
							</div>
							<div class="column mcb-column one-second column_promo_box service-box-right">
								<div class="promo_box no_border">
									<div class="promo_box_wrapper promo_box_right">
										<div class="photo_wrapper">
											<img class="scale-with-grid" src="/wp-content/uploads/2014/09/renovacion.png" alt="" width="493" height="191">
										</div>
										<div class="desc_wrapper">
											<div class="desc">
												<h5>VISA DE TURISMO</h5>
												<h3><b>RENOVACIÓN</b></h3>
											</div>
											<a href="/renovacion-de-visa/" id="btn-service" class="button button_left button_theme button_js kill_the_icon">
												<span class="button_icon">
													<i class="icon-plus"></i>
												</span>
												<span class="button_label">Ver Más</span>
						...
						echo '<div class="section-related-adjustment">';
							...
							echo '<div class="section-related-ul '. $related_cols .'">';
								...
								while ( $query_related_posts->have_posts() ){
									...
									echo '<div class="column post-related '. implode( ' ', get_post_class( $classes_rel ) ).'">';	
