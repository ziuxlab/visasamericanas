							...
							$output .= '<div class="image_frame post-photo-wrapper scale-with-grid">';
								$output .= '<div class="image_wrapper">';
									$output .= '<a href="'. get_permalink() .'">';
										$output .= get_the_post_thumbnail( get_the_ID(), 'blog', array( 'class'=>'scale-with-grid', 'itemprop'=>'image' ) );
									$output .= '</a>';
								$output .= '</div>';
							$output .= '</div>';
						...
						$output .= '<div class="post-desc">';
								...
								if( mfn_opts_get( 'blog-meta' ) ){
									$output .= '<div class="post-meta clearfix">';
										...
										$output .= '<div class="author-date">';	
											...
											if( $style == 'masonry tiles' && comments_open() ){
							...
							$output .= '<div class="post-title">';		
								...
								if( get_post_format() == 'quote' ){
									...
									// default ----------------------------
									$output .= '<h4 class="entry-title" itemprop="headline"><a href="'. get_permalink() .'">'. get_the_title() .'</a></h4>';
								}
								
							$output .= '</div>';
		
							// content -------------------------------------
							$output .= '<div class="post-excerpt">'. substr( strip_tags(get_the_excerpt() ), 0, 100 ) .'</div>';
