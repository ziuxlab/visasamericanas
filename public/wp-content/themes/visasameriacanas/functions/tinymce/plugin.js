		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Hover Color',
					onclick : function() {
						editor.insertContent('[hover_color background="" background_hover="" link="" class="" target=""]Insert your content here[/hover_color]');
					}				
				}, {
					text : 'How It Works',
					onclick : function() {
					...
					text : 'Portfolio',
					onclick : function() {
						editor.insertContent('[portfolio count="2" category="" style="grid" columns="3" filters="0" greyscale="0" orderby="date" order="DESC" pagination="0"]');
					}
				}, {
